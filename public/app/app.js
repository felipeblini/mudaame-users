...
angular.module('myApp', ['ngRoute', 'ngCookies', 'ui.bootstrap', 'ui.bootstrap.datetimepicker',
	...
	.config(['$routeProvider', function ($routeProvider) {
		$routeProvider
			...
			.when('/profile/',			 { templateUrl: 'views/profile/list.html',   controller: 'ListProfileController' })
			.when('/profile/select',	 { templateUrl: 'views/profile/select.html', controller: 'SelectProfileController' })
			.when('/profile/add',        { templateUrl: 'views/profile/edit.html',   controller: 'EditProfileController' })
			.when('/profile/edit/:id', 	 { templateUrl: 'views/profile/edit.html',   controller: 'EditProfileController' })
			.when('/profile/delete/:id', { templateUrl: 'views/profile/edit.html', 	 controller: 'EditProfileController' })
			.when('/profile/view/:id', 	 { templateUrl: 'views/profile/edit.html', 	 controller: 'EditProfileController' })
