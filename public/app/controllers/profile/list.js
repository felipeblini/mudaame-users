angular.module('myApp').controller('ListProfileController', 
  ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'SecurityService', 'NavigationService', 'EntityUtilService', 'ProfileService', 
  function($http, $scope, $location, $q, $timeout, $modal, SecurityService, NavigationService, EntityUtilService, ProfileService) {
	...
	$scope.edit = function (obj) {
		$location.path('/profile/edit/' + obj._id);
	};
	$scope.view = function (obj) {
		$location.path('/profile/view/' + obj._id);
	};
	$scope.delete = function (obj) {
		$location.path('/profile/delete/' + obj._id);
	};
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(ProfileService, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(ProfileService, $scope.dataList, $scope.refresh);  
	}
